...
# Input Student's mark for each course
...
def print_full_info(students_data):
    print("\n{:<16} {:<16} {:<16} {:<16} {:<16} {:<16}".format("Student ID", "Name", "Date of Birth", "Course ID", "Course Name", "Mark"))
...
def print_student_info(students_data):
    print("\n{:<16} {:<16} {:<16}".format("Student ID", "Name", "Date of Birth"))
    for student_data in students_data:
...
def print_course_info(students_data):
    print("\n{:<16} {:<16}".format("Course ID", "Course Name"))
    for student_data in students_data:
        for course_data in student_data["c_data"]:
            print("{:<16} {:<16}".format(
                course_data["c_info"]["c_id"],
...
# Print student marks for given course
def print_student_course_marks(students_data):
    ...
    if not found:
        print("Sorry! Not found your information you accessed!.")
...
def main():
    ...
    while True:
        ...
        print("2. Print the list of student information")
        print("3. Print the list of course infomation")
        print("4. Print marks of astudent in a course")
        print("0. Exit")
